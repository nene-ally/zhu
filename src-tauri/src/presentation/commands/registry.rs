pub fn invoke_handler() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
    tauri::generate_handler![
        ...
        // Kaogong study commands (fixed namespace/key, persisted under the user data root)
        super::kaogong_commands::get_kaogong_data,
        super::kaogong_commands::save_kaogong_data,
